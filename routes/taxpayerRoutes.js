...
const express = require('express');
const router = express.Router();
const { createTaxpayer, getTaxpayers, getTaxpayersWithTaxes, associateTaxesToTaxpayer, getOneTaxpayerWithTaxes, getPaginatedTaxpayers} = require('../controllers/taxpayerController');
const authMiddleware = require('../middleware/authMiddleware');
const roleMiddleware = require('../middleware/roleMiddleware');
